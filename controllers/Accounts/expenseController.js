...
exports.createExpense = asyncHandler(async (req, res) => {
  ...
  const expense = await Expense.create({ ...req.body, hotelId: requireTenant(req), businessId: getBusinessId(req), sourceModule: "manual", sourceId: null, createdBy: req.user._id });
